...
TEST_F(IntSetTest, AddTest1) {
    ...
    int_set.Add(4);
    int_set.Add(3);
    ASSERT_DEATH(int_set.Add(2), "Exceeded capacity");
}
...
TEST_F(IntSetTest, AddTest3) {
    ...
    int_set.Add(2);
    int_set.Add(2);
    ASSERT_DEATH(int_set.Add(3), "Exceeded capacity");
}
...
TEST_F(IntSetTest, AddSetTest2) {
    ...
    ASSERT_DEATH(int_set.Add(int_set_1), "Exceeded capacity");
}
...
TEST_F(IntSetTest, MapTest3) {
    ...
    EXPECT_EQ(int_set.elements()[0], 9);
    EXPECT_EQ(int_set.elements()[1], 16);
    EXPECT_EQ(int_set.elements()[2], 25);
}
